---
name: github-issues
description: "Create, manage, triage, and close GitHub issues. Search existing issues, add labels, assign people, and link to PRs. Works with gh CLI or falls 返回 to git + GitHub REST API via curl."
version: 1.1.0
author: Hermes Agent
license: MIT
metadata:
