...
description: "Review code changes by analyzing git diffs, leaving inline comments on PRs, and performing thorough pre-push review. Works with gh CLI or falls 返回 to git + GitHub REST API via curl."
version: 1.1.0
author: Hermes Agent
license: MIT
metadata:
