---
name: instructor
description: "Extract structured data from LLM responses with Pydantic validation, 重试 failed extractions automatically, parse complex JSON with 输入 safety, and stream partial results with Instructor - battle-tested structured output library"
version: 1.0.0
